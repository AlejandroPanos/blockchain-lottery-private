...
interface IERC20 {
    ...
    // Returns bool to check if client can transfer to the jackpot
    function transferLottery(address _client, address _recepient, uint256 _amount) external returns(bool);
...
contract ERC20Basic is IERC20 {
    ...
    // Transfer lottery
    function transferLottery(address _client, address _recipient, uint256 _amount) public override returns(bool){
        // Check we have enough tokens
